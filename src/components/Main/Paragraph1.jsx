...
const FirstParagraph = () => {
  return (
    <div>
      <p className="TextContainer-paragraph1">
        ...
        quisque. In sollicitudin sapien, vel nulla quisque vitae. Scelerisque
        eget accumsan, non in. Posuere magna erat bibendum amet, nisi eu id.
        <br />
        <br />
        Viverra at diam nunc non ornare. Sed ultricies pulvinar nunc, lacus sem.
        Tellus aliquam ut euismod cursus dui lectus. Ut amet, cras volutpat dui.
        A bibendum viverra eu cras.
        <br />
        ...
        tristique. Integer faucibus duis praesent tempor feugiat ornare in. Erat
        ...
        rhoncus, est nunc nisi volutpat, amet venenatis faucibus. Enim, vel nunc
        purus feugiat purus tincidunt neque. Massa ultricies faucibus
